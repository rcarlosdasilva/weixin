...
enum class ResultCode(val code: Int, val text: String) {
  ...
  RESULT_45011(45011, "API 调用太频繁，请稍候再试"),
  ...
  RESULT_48002(48002, "粉丝拒收消息（粉丝在公众号选项中，关闭了 “ 接收消息 ” ）"),
