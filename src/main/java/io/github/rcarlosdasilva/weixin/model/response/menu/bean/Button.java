...
public class Button {
   ...
   * value、url、key等字段.
   * 
   * <p>对于不同的菜单类型，value的值意义不同。
   * 
   * <p>官网上设置的自定义菜单： <br>&nbsp;&nbsp;&nbsp;&nbsp;Text:保存文字到value；
   * <br>&nbsp;&nbsp;&nbsp;&nbsp;Img、voice：保存mediaID到value；
   * <br>&nbsp;&nbsp;&nbsp;&nbsp;Video：保存视频下载链接到value；
   * <br>&nbsp;&nbsp;&nbsp;&nbsp;News：保存图文消息到news_info，
   * 同时保存mediaID到value； <br>&nbsp;&nbsp;&nbsp;&nbsp;View：保存链接到url。
   * 
   * <p>使用API设置的自定义菜单：
   * <br>&nbsp;&nbsp;&nbsp;&nbsp;click、scancode_push、scancode_waitmsg、
   * pic_sysphoto、
   * pic_photo_or_album、pic_weixin、location_select：保存值到key；
   * <br>&nbsp;&nbsp;&nbsp;&nbsp;view：保存链接到url
   * 
   */
