...
public interface MediaApi {
   ...
   * 新增永久图文素材.
   * <p>
   * 公众号的素材库保存总数量有上限：图文消息素材、图片素材上限为5000，其他类型为1000。<br>
   * 图文消息的具体内容中，微信后台将过滤外部的图片链接，图片url需通过"上传图文消息内的图片获取URL"接口上传图片获取。<br>
   ...
   * 删除永久素材.
   * <p>
   * 在新增了永久素材后，开发者可以根据本接口来删除不再需要的永久素材，节省空间。 <br>
   * 请注意： <br>
   * 1、请谨慎操作本接口，因为它可以删除公众号在公众平台官网素材管理模块中新建的图文消息、
   * 语音、视频等素材（但需要先通过获取素材列表来获知素材的media_id）<br>
   * 2、临时素材无法通过本接口删除 <br>
   * 3、调用该接口需https协议
   * 
   * @param mediaId
   ...
   * 修改永久图文素材.
   * <p>
   * 开发者可以通过本接口对永久图文素材进行修改。 <br>
   * 请注意： <br>
   * 1、也可以在公众平台官网素材管理模块中保存的图文消息（永久图文素材） <br>
   * 2、调用该接口需https协议
   * 
   * @param mediaId
   *          要修改的图文消息的media_id
   ...
   * 获取素材总数.
   * <p>
   * 开发者可以根据本接口来获取永久素材的列表，需要时也可保存到本地。<br>
   * 请注意：<br>
   ...
   * 请注意：<br>
   * 1、获取永久素材的列表，也包含公众号在公众平台官网素材管理模块中新建的图文消息、语音、视频等素材<br>
   * 2、临时素材无法通过本接口获取<br>
   * 3、调用该接口需https协议
   * 
   * @param type
